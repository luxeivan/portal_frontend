        ...
        <Card title={"Контактная информация"} >
                    ...
                    <p>
                        <Typography.Text
                            copyable={{
                                ...
                                tooltips: ["Скопировать адрес юридического лица", "Адрес юридического лица скопирован"],
                                icon: <CopyOutlined />,
                                onCopy: () => handleCopy("Адрес юридического лица"),
                            }}
                        >
                            143421 Московская область, г.о. Красногорск, автодорога Балтия
                            тер 26 км, Бизнес-центр Рига-Ленд, стр. Б3, подъезд 3, этаж 7,
                            помещ. 2, ком. 1
                        </Typography.Text>
                    </p>
                </Col>
                    ...
                    <p>
                        <Typography.Text
                            copyable={{
                                ...
                                tooltips: ["Скопировать адрес для корреспонденции", "Адрес для корреспонденции скопирован"],
                                icon: <CopyOutlined />,
            ...
            <Row gutter={[16, 16]} align="top">
                ...
                <Col flex="1">
                    ...
                    <p>
                        <b><a href="tel:+74957803962" style={{ color: "#0061aa" }}>+7 (495) 780-39-62</a></b>
                    </p>
                </Col>
            </Row>
        </Card>
