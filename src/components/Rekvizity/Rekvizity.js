...
import { Typography, Card, Row, Col, message, Collapse } from "antd";
...
export default function Rekvizity() {
  ...
  return (
    <div className="page-grid__content" id="content">
      ...
      <Collapse>
        {/* Блок с контактами */}
        <Collapse.Panel header="Контактная информация" key="1">
        ...
        <Collapse.Panel header="Банковские реквизиты" key="2">
