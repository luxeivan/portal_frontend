      ...
      if (response.data && response.data.data) {
        ...
        setSuggestions(
          response.data.data.map((s) => ({
            value: s.data.inn,
            label: `${s.data.name.short_with_opf} КПП: ${s.data.kpp}`,
            kpp: s.data.kpp,
          }))
        );
      } else {
...
//   value = {},
//   setShowModal,
//   form,  // Используем form, переданный через props
//   handlerSubmitForm,
//   handlerDelete,
//   handlerEdit,
// }) => {
...
//     }
//     try {
//       const response = await axios.get(`${config.backServer}/api/cabinet/get-inn/LEGAL?inn=${searchText}`, {
//         headers: {
//           "Content-Type": "application/json",
//           Authorization: `Bearer ${localStorage.getItem("jwt")}`,
//         },
...
//           kpp: s.kpp,
//           hid: s.hid,
//           label: `${s.fullName} (ИНН: ${s.inn}, КПП: ${s.kpp})`,
//         })));
//       } else {
//         setSuggestions([]);
//       }
