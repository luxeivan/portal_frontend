        ...
        <div className={styles.totalPowerContainer}>
          ...
          {showAdditionalInfo && (
            <Paragraph style={{ textAlign: "justify", marginTop: "20px" }}>
              ...
              по III категории надежности. Для электроприемников третьей
              ...
              электроснабжения, не превышают 1 суток. Электроприемники второй
              категории в нормальных режимах должны обеспечиваться
              электроэнергией от двух независимых взаимно резервирующих
              источников питания. Для электроприемников второй категории при
