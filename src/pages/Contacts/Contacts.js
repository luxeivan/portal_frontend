        ...
        {contactCenters.map((center, index) => (
          <Collapse.Panel header={center.name} key={index}>
            ...
            {center.photos && center.photos.ПутьКФайлу ? (
              <div style={{ marginBottom: "10px" }}>
                <strong>Фото филиала:</strong>{" "}
                <img
                  src={`${backServer}/${center.photos.ПутьКФайлу}`} // Используем ПутьКФайлу с сервера
                  alt={center.name}
...
//             {/* Добавляем отображение фотографии */}
//             {center.photos && center.photos.ПутьКФайлу ? (
//               <div style={{ marginBottom: "10px" }}>
//                 <strong>Фотография:</strong>
//                 <img
//                   src={`${center.photos.ПолныйПутьWindows}${center.photos.ПутьКФайлу}`}
//                   alt={`Фото филиала ${center.name}`}
//                   style={{
//                     maxWidth: "100%",
//                     height: "auto",
//                     marginTop: "10px",
...
//             ) : (
//               <div style={{ marginBottom: "10px" }}>
//                 <strong>Фотография:</strong> Информация отсутствует
//               </div>
//             )}
